...
<template>
  ...
  <NuxtLink :to="{ name: 'users-id', params: { id: 1 } }"> Utilisateur 1 </NuxtLink>

  <!-- Navigation externe -->
  <NuxtLink to="https://example.com" external> Site externe </NuxtLink>

  <!-- Préchargement désactivé -->
  <NuxtLink to="/heavy-page" :prefetch="false"> Page lourde </NuxtLink>
</template>
```
